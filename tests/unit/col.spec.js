...
import Vue from 'vue'
import Row from '../../src/packages/row.vue'
...
describe('Col', () => {
    ...
    it('接收 narrow-pc 属性', () => {
        ...
        const element = vm.$el
        expect(element.classList.contains('col-narrow-1')).to.eq(true)
        expect(element.classList.contains('offset-narrow-2')).to.eq(true)   
    ...
    it('接收 wide-pc 属性', () => {
        ...
        const element = vm.$el
        expect(element.classList.contains('col-wide-1')).to.eq(true)
        expect(element.classList.contains('offset-wide-2')).to.eq(true)  
